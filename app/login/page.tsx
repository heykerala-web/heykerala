    ...
    <main className="min-h-screen flex">
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          {success && (
            <div className="rounded-md bg-emerald-50 border border-emerald-200 p-4">
              <p className="text-sm text-emerald-800">Registration successful! Please sign in.</p>
            </div>
          )}
      ...
      <div className="hidden lg:block flex-1 relative">
        ...
        <div className="absolute bottom-8 left-8 text-white">
          <h2 className="text-3xl font-bold">Discover Kerala</h2>
          <p className="mt-2 text-lg opacity-90">Where every path unfolds your story</p>
        </div>
      </div>
    </main>
  )
